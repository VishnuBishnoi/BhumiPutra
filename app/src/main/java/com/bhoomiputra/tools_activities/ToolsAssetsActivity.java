...
import com.bhoomiputra.farmer_activities.AssetsActivity;
import com.bhoomiputra.farmer_activities.BhumiPutraApi;
import com.bhoomiputra.farmer_activities.FarmerHomeActivity;
...
import com.bhoomiputra.tools_activities.ToolManpowerAssetActivity.RegisterTask;
...
btnSubmit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				else
				{
 				...
 				String registerUrl=BhumiPutraApi.getToolProviderRegester();
