...
import com.bhoomiputra.tools_activities.ToolsManpowerHomeActivity;
...
public class FarmerLoginActivity extends Activity {
	...
	EditText etMobileNo;
	EditText etPassword;
	ArrayAdapter<String> adapterUsserType;
	Spinner spinerUsersType;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
		...
		adapterUsserType=new ArrayAdapter<String>(FarmerLoginActivity.this, android.R.layout.simple_list_item_1,getResources().getStringArray(R.array.user_names_array));
