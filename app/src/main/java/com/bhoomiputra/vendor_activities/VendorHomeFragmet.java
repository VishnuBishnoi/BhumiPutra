...
public class VendorHomeFragmet extends Fragment {
	TextView tvname;
	TextView tvmobile;
	TextView tvid;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		String url=BhumiPutraApi.getGetVendorById();
		...
		String url2=BhumiPutraApi.getGetVendorProfilePic();
